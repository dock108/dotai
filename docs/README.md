...
- [`eda-current-state.md`](eda-current-state.md) - MVP surface and feature flags
- [`FEATURE_LAYERS.md`](FEATURE_LAYERS.md) - How features are handled (internal)
- [`../future/`](../future/) - Parked feature designs (v2+)
