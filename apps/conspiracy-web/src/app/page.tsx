...
/**
 * Main page component for conspiracy theory evaluation.
 * 
 * Uses the shared useConspiraciesEvaluation hook from @dock108/js-core
 * which handles API communication with the theory-engine-api backend.
 * 
 * The evaluation flow:
 * 1. User submits theory text via TheoryForm
 * 2. Hook calls POST /api/conspiracies/evaluate
 * 3. Backend returns narrative-driven analysis with evidence comparison
 * 4. TheoryCard displays the structured response
 */
