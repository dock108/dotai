...
/**
 * Lesson metadata loaded from puzzles.json.
 * 
 * Lessons are sourced from the Swift prototype's puzzle definitions
 * to maintain consistency between web and iOS versions.
 */
interface Lesson {
  id: number;
  number: number;
...
/**
 * Home page component displaying available lessons.
 * 
 * Fetches lesson list from /api/lessons (which reads from puzzles.json)
 * and renders a grid of lesson cards. Clicking a card navigates to
 * the game page for that lesson.
 */
