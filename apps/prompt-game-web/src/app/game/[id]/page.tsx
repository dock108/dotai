...
/**
 * Lesson data structure with game-specific fields.
 */
interface Lesson {
  id: number;
  number: number;
...
/**
 * Chat message in the game conversation.
 */
interface Message {
  role: "user" | "assistant";
  content: string;
...
/**
 * Score response from the evaluation API.
 * 
 * Contains verdict (pass/fail), confidence score, reasoning explanation,
 * and any guardrail flags triggered by the user's prompt.
 */
...
/**
 * Game page component for interactive prompt training.
 * 
 * Provides a chat interface where users practice prompting AI:
 * - Displays lesson scenario, goal, and answer format
 * - Tracks conversation history and turn count
 * - Submits prompts to /api/game/score for evaluation
 * - Displays score card with verdict, confidence, and reasoning
 * 
 * Game ends when maxTurns is reached or user achieves the goal.
 */
