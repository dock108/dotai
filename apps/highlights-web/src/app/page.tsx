...
/**
 * Main page component for building sports highlight playlists.
 * 
 * Provides a query builder interface where users can:
 * - Select sports, teams, players, and play types
 * - Set date ranges (presets or custom)
 * - Configure duration (1h-10h)
 * - Add optional comments for context
 * 
 * On submission, calls POST /api/highlights/plan via HighlightsAPI
 * and redirects to the playlist detail page on success.
 */
