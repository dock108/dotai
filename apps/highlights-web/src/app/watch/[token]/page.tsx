 ...
 * 
 * The YouTube iframe API is loaded dynamically and provides
 * programmatic control over embedded video players.
 */
declare global {
  interface Window {
    YT: any;
...
/**
 * Watch page component for viewing highlight playlists via temporary token.
 * 
 * Provides a full-screen YouTube player with:
 * - Auto-play through playlist videos
 * - Playback controls (play/pause, volume, progress)
 * - Video navigation (next/previous)
 * - Token expiration countdown
 * 
 * Fetches playlist data via GET /api/highlights/watch/{token} on mount.
